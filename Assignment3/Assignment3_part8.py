...
def find_lowestCommonMultiple(theDataOne, theDataTwo):
    ...
    return ((theDataOne*theDataTwo)/greatestCommonDivisor)        
...
system('clear')
print('The Lowest common multiple of '+str(dataOne)+' and '+str(dataTwo)+' is equal to '+str(find_lowestCommonMultiple(dataOne, dataTwo))+'\n')        
