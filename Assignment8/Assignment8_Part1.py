...
class Fraction:
    ...
    def find_lowestCommonMultiple(self, theDataOne, theDataTwo):
        return int((theDataOne*theDataTwo)/self.find_greatestCommonDivisor(theDataOne, theDataTwo))
    
    def find_greatestCommonDivisor(self, theDataOne, theDataTwo):
        minimum=min(theDataOne,theDataTwo)
        greatestCommonDivisor=0
        for i in range(1, minimum+1):
            if((theDataOne%i==0) and (theDataTwo%i==0)):
                greatestCommonDivisor=i
        return int(greatestCommonDivisor)
    ...
    def print(self):
        print('{}/{}'.format(self.numerator, self.denominator), end='')
    
    def simplify(self):
        
        temp_Numerator = int(self.numerator/self.find_greatestCommonDivisor(self.numerator, self.denominator))
        self.denominator = int(self.denominator/self.find_greatestCommonDivisor(self.numerator, self.denominator))
