...
class Fraction:
    ...
    def __add__(self, theObject):
        ...
        return '{0}/{1}'.format(self.numerator+theObject.numerator, lowestCommonMultiple)   
    ...
    def __mul__(self, theObject):
        return '{0}/{1}'.format(self.numerator*theObject.numerator, self.denominator*theObject.denominator)
    
    def __truediv__(self, theObject):
        return '{0}/{1}'.format(self.numerator*theObject.denominator, self.denominator*theObject.numerator)        
...
while True:
    ...
    match choice:
        case 1: 
            ...
            system('clear')
            print('{0}/{1} + {2}/{3} = {4}'.format(fractionOne.numerator, fractionOne.denominator, fractionTwo.numerator, fractionTwo.denominator, fractionOne+fractionTwo))
            input()
        case 2:
            system('clear')
            fractionOne.set_numerator(get_numerator('first'))
